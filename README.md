...
- **SciPy:** Kernel Density Estimation for PDF approximation
...
- **Language:** Python 3.8+
- **Dataset Access:** Local CSV file from Kaggle
- **Hardware:** CPU or GPU (CUDA enabled)

## 14. How to Run

1. Ensure all dependencies are installed
2. Load the dataset `data.csv` in the notebook
3. Execute cells sequentially from top to bottom
4. Monitor training progress through console output
5. Visualize results in the final output cell
...
**Student ID:** 102303921

## 17. Academic Purpose

This project is submitted as an assignment to demonstrate understanding of:
